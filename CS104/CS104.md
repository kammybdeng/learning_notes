...
## How Computers Work
[Diagram](https://computersciencewiki.org/images/1/1a/Cpu_diagram.png)
...
2. **Processing**:
    - **Central Processing Unit(CPU)**:
        ...
        3. ** Registers (Immediate Access Store): limited, temporary memory area that CPU can quickly access
...
3. **Memory**:
    - **RAM**: Random Access Memory -> Primary Memory
        a. **Primary Memory (known as Main memory)**: where computer stores data and information for *fast access*. It is *volatile* memory, which means data is stored *temporarily* and requires power to maintain.
...
![Logic Gates Chart](https://michellescomputerscience.files.wordpress.com/2016/08/logic-gates.jpg?w=490)
...
## Data-Level Parallelism: an approach aims to increase data throughput by operating on multiple elements simultaneously
Single Instruction, Multiple Data (SIMD): use one instruction to work on multiple elements of data
1. Vector Processing
2. SIML Extensions
